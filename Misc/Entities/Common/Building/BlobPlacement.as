...
// give hack for assassin and musketman.
...
void PositionCarried(CBlob@ this, CBlob@ carryBlob)
{
	...
	else
	{
		...
		if (hands !is null)
		{
			...
			{
				if ((this.getName() == "archer" || this.getName() == "assassin" || this.getName() == "musketman") && sprite.isAnimation("crouch")) //hack for archer prone
				{
					hands.offset.y -= 4;
					hands.offset.x += 2;
				}
