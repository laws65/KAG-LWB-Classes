...
const string[] classes = {"builder", "knight", "archer", "rockthrower", "medic", "spearman", "assassin", "crossbowman", "musketman"};
const string[][] highlight_items = {
/* 0 */	{"mat_stone", "mat_wood", "mat_gold"}, //builder
/* 1 */	{"mat_bombs", "mat_waterbombs", "keg"}, //knight
/* 2 */	{"mat_arrows", "mat_firearrows", "mat_waterarrows", "mat_bombarrows", "mat_poisonarrows"}, //archer
/* 3 */	{"mat_stone", "mat_wood", "boulder"}, //rockthrower
/* 4 */	{"mat_medkits", "mat_waterjar", "mat_poisonjar", "mat_acidjar"}, //medic
/* 5 */	{"mat_spears", "mat_firespears", "mat_poisonspears"}, //spearman
/* 6 */	{"mat_smokeball"}, //assassin
/* 7 */	{"mat_arrows", "mat_firearrows", "mat_poisonarrows"}, //crossbowman
/* 8 */	{"mat_bullets", "mat_barricades"} //musketman
};
