// Chest.as
// added new classes' loot and DTS script
...
void onInit(CBlob@ this)
{
	...
	if (getNet().isServer())
	{
		...
		if (rules.gamemode_name == TDM || rules.gamemode_name == "Destroy the Statue")
		{
...
void onCommand(CBlob@ this, u8 cmd, CBitStream @params)
{
	if (cmd == this.getCommandID("activate"))
	{
		...
		if (getNet().isServer())
		{
			...
			{
				addLoot(this, INDEX_SPEARMAN, 1, 0);
			}
			else if (NAME == "assassin")
			{
				addLoot(this, INDEX_ASSASSIN, 1, 0);
			}
			else if (NAME == "rockthrower")
			{
				addLoot(this, INDEX_ROCKTHROWER, 1, 0);
			}
			else if (NAME == "medic")
			{
				addLoot(this, INDEX_MEDIC, 1, 0);
			}
			...
			{
				addLoot(this, INDEX_MUSKETMAN, 1, 0);
			}
