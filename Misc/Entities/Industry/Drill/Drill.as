// Drill.as
// now rockthrower can use drills, but other classes can't use in TDM.
...
void onTick(CBlob@ this)
{
	...
	if (this.isAttached())
	{
		...
		if (holder.getName() == required_class || holder.getName() == "rockthrower")
		{
...
void onRender(CSprite@ this)
{
	...
	if (holderBlob.getName() != required_class &&  holderBlob.getName() != "rockthrower"){return;}
