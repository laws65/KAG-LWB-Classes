...
//added new classes' spawn items and icons.
...
shared class TDMCore : RulesCore
{
				...
				if (player.team == team_num)
				{
					...
					if (e_player !is null)
					{
						...
						if (blob_alive)
						{
							...
							else if (player_blob.getName() == "medic")
							{
								player_char = "m";
							}
							else if (player_blob.getName() == "spearman")
							{
								player_char = "p";
							}
							else if (player_blob.getName() == "assassin")
							{
								player_char = "i";
							}
							else if (player_blob.getName() == "crossbowman")
							{
								player_char = "c";
							}
							else if (player_blob.getName() == "musketman")
							{
								player_char = "u";
							}
	...
	string getClassAmmo(string name)
	{
		...
		else if(name == "musketman") return "mat_bullets";
