...
void SetupScrolls(CRules@ this)
{
...

	{
		...
		addScrollItemsToArray("Spears", "mat_spears", 	m * 5, false, 3, @def.items);
		addScrollItemsToArray("Smoke Balls", "mat_smokeball", 	m * 5, false, 3, @def.items);
		addScrollItemsToArray("Bullets", "mat_bullets", 	m * 5, false, 3, @def.items);
		addScrollItemsToArray("Med Kits", "mat_medkits", 	m * 5, false, 3, @def.items);
...

	{
		...
		def.connections.push_back("water ammo");
		def.connections.push_back("poison");
		addScrollItemsToArray("Acid Jars", "mat_acidjar", 	m * 10, false, 1, @def.items);
		//addScrollItemsToArray( "Arrows", "mat_arrows", 	m*60, false, 1, @def.items );
...

	{
		...
		addScrollItemsToArray("Water Jars", "mat_waterjar", 	m * 5, false, 3, @def.items);
...

	{
		...
		def.connections.push_back("pyro");
		def.connections.push_back("bomb ammo");
		addScrollItemsToArray("Poison Arrows", "mat_poisonarrows", 	m * 5, false, 3, @def.items);
		addScrollItemsToArray("Poison Spears", "mat_poisonspears", 	m * 5, false, 3, @def.items);
		addScrollItemsToArray("Poison Jars", "mat_poisonjar", 	m * 5, false, 3, @def.items);
		all.scrolls.set("poison", def);
	}

	// now mounted bow tech is camping tech and in
	{
		ScrollDef def;
		def.name = "Camping";
		...
		addScrollItemsToArray("Barricade Frames", "mat_barricades", 	m * 30, false, 1, @def.items);
...

	{
		...
		addScrollItemsToArray("Fire Spears", "mat_firespears", 	m * 10, false, 3, @def.items);
