...
void MakeWarTradeMenu(CBlob@ trader)
{
	...
	// build menu
	CreateTradeMenu(trader, Vec2f(3, 12), "Trade");
...
//	addTradeScrollFromScrollDef(trader, "saw", cost_crappiest, Descriptions::saw);
	...
	addTradeScrollFromScrollDef(trader, "mounted_bow", WARCosts::medium_scroll, Descriptions::mounted_bow + "\nAlso it works as camping technology.");
	...
	addTradeScrollFromScrollDef(trader, "drill", WARCosts::crappy_scroll, Descriptions::drill);
	...
	addTradeScrollFromScrollDef(trader, "poison", WARCosts::crappy_scroll, "Items used for making enemies weak.");
	addTradeScrollFromScrollDef(trader, "acid", WARCosts::crappy_scroll, "The matter find in research of alchemy. Can melt manythings.");
	addTradeEmptyItem(trader);
