// management structs
// added new classes can get items.
...
shared class WarPlayerInfo : PlayerInfo
{
	...
	bool canGetBuilderItems;// and rockthrower
	bool canGetMedicItems;
	bool canGetMusketmanItems;
	...
	void Setup(string _name, u8 _team, string _default_config)
	{
		...
		suicide = false;
		canGetArcherItems = canGetKnightItems = canGetBuilderItems = canGetMedicItems = canGetMusketmanItems = canGetSpearmanItems = canGetAssassinItems = true;
	}
