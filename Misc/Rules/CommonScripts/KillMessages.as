	...
	void Render()
	{
		...
		for (uint message_step = 0; message_step < count; ++message_step)
		{
			...
			switch (message.hitter)
			{
				...
				case Hitters::hammer:  	hitterIcon = "$killfeed_hammer$"; break;
				case Hitters::acid:  	hitterIcon = "$killfeed_acid$"; break;
				case Hitters::bayonet:  	hitterIcon = "$killfeed_bayonet$"; break;
				case Hitters::bullet:  	hitterIcon = "$killfeed_bullet$"; break;
				case Hitters::spear:  	hitterIcon = "$killfeed_spear$"; break;
				case Hitters::thrownspear:  	hitterIcon = "$killfeed_thrownspear$"; break;
				case Hitters::stab:  	hitterIcon = "$killfeed_stab$"; break;
				case Hitters::shovel:  	hitterIcon = "$killfeed_shovel$"; break;
...
void onInit(CRules@ this)
{
	...
	AddIconToken("$killfeed_acid$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 3);
	AddIconToken("$killfeed_bayonet$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 4);
	AddIconToken("$killfeed_bullet$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 5);
	AddIconToken("$killfeed_spear$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 6);
	AddIconToken("$killfeed_thrownspear$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 7);
	AddIconToken("$killfeed_stab$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 8);
	AddIconToken("$killfeed_shovel$", "GUI/LWBKillfeedIcons.png", Vec2f(32, 16), 9);
}
