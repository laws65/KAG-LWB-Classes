...
//now it works with spearman too
...
f32 onHit(CBlob@ this, Vec2f worldPoint, Vec2f velocity, f32 damage, CBlob@ hitterBlob, u8 customData)
{
	...
	if (hitterBlob.getPosition().x < this.getPosition().x && (hitterBlob.getName() == "knight" || hitterBlob.getName() == "spearman" || hitterBlob.getName() == "crossbowman")) // knight and the left one (to play only once)
	{
